...
// src/modules/endpoint/endpoint.templates.ts
var endpointsTemplate = (appName) => `// This file is auto-generated. Do not edit manually.
...
// src/modules/endpoint/index.ts
async function writeDefaultContractEndpoint(config) {
  const endpointDirectoryPath = await askWhereToWriteEndpoint();
  fs2.ensureDirSync(endpointDirectoryPath);
  ...
  fs2.writeFileSync(endpointsFilePath, endpointsTemplate(config.appName));
